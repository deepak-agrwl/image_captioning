...
# === Paths ===
DATA_DIR = "../../resources/input/flickr30k/Images"
CSV_PATH = os.path.join(DATA_DIR, "results.csv")  # Your CSV with | separated fields
IMAGE_DIR = os.path.join(DATA_DIR, "flickr30k_images")
OUTPUT_DIR = "./checkpoints_vit_gpt2"
IMAGE_DIR = "../../resources/input/flickr30k/Images"
...
train_dataset = Flickr30kDataset(train_df, tokenizer, feature_extractor, IMAGE_DIR)
val_dataset = Flickr30kDataset(val_df, tokenizer, feature_extractor, IMAGE_DIR)
...
training_args = Seq2SeqTrainingArguments(
    ...
    fp16=False  # only if using GPU with mixed precision
)
