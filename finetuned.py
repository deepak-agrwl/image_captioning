...
DATASET_CONFIGS = {
    ...
    'flickr30k': {
        'image_dir': "../../resources/input/Flickr30k/flickr30k_images",
        'captions_file': "../../resources/input/Flickr30k/captions.csv",
        'image_col': 'image',
        'caption_col': 'caption',
        'file_format': 'csv'
    }
...
class CustomDataset(Dataset):
    ...
    def __init__(self, root_dir, captions_file, transform=None, freq_threshold=5, dataset_type='flickr8k'):
        ...
        print(f"Debugging: dataset_type received: '{dataset_type}'") # Add this line
...
class DecoderRNNWithAttention(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab_size, encoder_dim=None, attention_dim=256, num_layers=1
...
def train_model(model, data_loader, dataset, device, num_epochs=2, learning_rate=0.0001, print_every=2000, dataset_type='flickr8k', val_fraction=0.2, decoder_type='lstm', start_epoch=1, optimizer=None, scheduler=None):
